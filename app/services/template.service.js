const from = '"Placement Portal" <prataprajat2000@gmail.com>';
//const baseUrl = 'http://prataprajat2000@gmail.com';
const email_signature = '<br><br>With Regards.<br><br>Abhishek Pratap Singh<br>Creator, Training & Placement<br>AITH Kanpur<br>7275297200';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                subject: 'Login Request : Placement Cell, AITH Kanpur',
        ...
        case 'forgotPassword':
            return {
                from: from,
                to: data.college_email,
                subject: 'Reset Password Request : Placement Cell, AITH Kanpur',
        ...
        case 'passwordUpdated':
            return {
                from: from,
                to: data.college_email,
                subject: 'Password Updated : Placement Cell, AITH Kanpur',
                text: 'Hello '+ data.student_name + 'Your password has been successfully updated.With Regards, Abhishek Pratap Singh',
        ...
        case 'approveInterviewExperience':
            return {
                ...
                text: 'Hello '+ data.author_name + 'Thanks for sharing your interview process and thoughts with us With Regards, Abhishek Pratap Singh',
